...
//						Gimbal_Auto_Shoot.target_pit = 0;
    ...
    if ( Gimbal_Auto_Shoot.Recognized_Flag )
    {
        ...
        if ( new_location.recogflag )
        {
						...
						{
//								Gimbal_Auto_Shoot.Pit_Gimbal_Delay_Compensation = (Gimbal_Auto_Shoot.target_pit - PITCH_MAX)*(-0.035);//»·ÐÎ¸ßµØÏÂ
								Gimbal_Auto_Shoot.Pit_Gimbal_Delay_Compensation = (Gimbal_Auto_Shoot.target_pit - PITCH_MAX)*(-1.5);//»·ÐÎ¸ßµØÉÏ
